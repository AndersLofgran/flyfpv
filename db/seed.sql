...
"Two of Lumenier's most popular antennas can now be found sharing the same box! We figured we would save you a few clicks (and a few dollars) by making the perfect diversity combo. The renowned AXII 2 antenna gives clear and even signal in near perfect circularity, while the newly released AXII Patch Antenna will give you incredible range and penetration where it is pointed. A perfect upgrade for your goggles or ground station. By purchasing this bundle, you will be saving money compared to buying the antennas separately.
This combo also comes with two SMA adapters (90, 45 degrees) to make installation a breeze."
),
